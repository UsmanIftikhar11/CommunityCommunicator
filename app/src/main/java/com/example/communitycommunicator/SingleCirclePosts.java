...
public class SingleCirclePosts extends AppCompatActivity {
    ...
    private String circleName, userName ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_single_circle_posts);
    ...
    private void upoadPost() {
                ...
                })
        {
            ...
            public Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("category" , circleName);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            SingleCircleAdapter adapter = new SingleCircleAdapter(SingleCirclePosts.this, productList);
