...
public class BusinessAdapter extends RecyclerView.Adapter<BusinessAdapter.ProductViewHolder>{
    ...
    public BusinessAdapter(Context mCtx, List<Product> productList) {
        this.mCtx = mCtx;
