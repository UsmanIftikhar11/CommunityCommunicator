...
public class HelthAdapter extends RecyclerView.Adapter<HelthAdapter.ProductViewHolder>{
    ...
    public HelthAdapter(Context mCtx, List<Product> productList) {
        this.mCtx = mCtx;
