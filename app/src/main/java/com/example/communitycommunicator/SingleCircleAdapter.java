...
public class SingleCircleAdapter extends RecyclerView.Adapter<SingleCircleAdapter.ProductViewHolder>{
    ...
    public SingleCircleAdapter(Context mCtx, List<Product> productList) {
        this.mCtx = mCtx;
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (success.equals("1")) {
                                    ...
                                    ((SingleCirclePosts) mCtx).recreate();
